...
function App() {
  ...
  return <main>
    ...
    <aside><span>⌁</span><div><strong>Como funciona?</strong><p>Além de recalcular os verificadores, o CPF Ajuste testa uma troca por vez nos nove primeiros algarismos, preservando os verificadores informados. Pode haver mais de uma possibilidade matemática; a sugestão não comprova titularidade.</p></div></aside>
